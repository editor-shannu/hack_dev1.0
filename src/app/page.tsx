              ...
              {followUps.map((item) => {
                ...
                return (
                  <button
                    ...
                    className="p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-sm hover:shadow-md hover:border-[#0F58B6] dark:hover:border-blue-500 transition-all flex flex-col justify-between text-left group cursor-pointer active:scale-[0.98]"
